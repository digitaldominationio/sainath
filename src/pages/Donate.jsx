      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-slate-600 max-w-2xl mx-auto mt-4 leading-relaxed text-lg">
            We maintain complete transparency in all financial and operational
            processes. Every contribution helps us reach more people in need.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
          {/* Left: PAN Image */}
          <div
            className="group relative rounded-3xl p-4 shadow-xl border border-slate-100 cursor-pointer overflow-hidden transform hover:-translate-y-1 transition-all duration-300"
            style={{ backgroundColor: '#192337bf' }}
            ...
            <div className="bg-teal-50 rounded-3xl p-8 border border-teal-100">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className="text-xl text-slate-800 font-mono font-bold tracking-wide">
                    AAQTS0493M
                  </p>
                </div>
              ...
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-10 gap-4">
                <div>
                  ...
                  <p className="text-slate-400 mt-2">
                    Use these details to make a direct bank transfer.
                  </p>
                </div>
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <p className="text-xl font-medium">
                      Chandrashekhar Pur Branch, Bhubaneswar
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <div className="flex items-center gap-4 group">
                      <p className="text-2xl font-mono tracking-widest text-white group-hover:text-teal-400 transition-colors">
                        1022 0004 8920 23
                      </p>
                      <button
                        onClick={() =>
                          navigator.clipboard.writeText("10220004892023")
                        }
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-4 group">
                      <p className="text-xl font-mono tracking-wider text-white group-hover:text-teal-400 transition-colors">
                        BDBL0002215
                      </p>
                      <button
                        onClick={() =>
                          navigator.clipboard.writeText("BDBL0002215")
                        }
                        className="opacity-0 group-hover:opacity-100 bg-white/20 hover:bg-white/30 p-2 rounded-lg transition-all"
                    ...
                    <p className="text-sm text-slate-400 mt-2">City</p>
                    <p className="text-xl font-semibold tracking-wide">
                      Bhubaneswar
                    </p>
                  </div>
